...
export class WeightedPoolNoAMFactory__getCreationCodeContractsResult {
  value0: Address;
  value1: Address;
...
export class WeightedPoolNoAMFactory__getPauseConfigurationResult {
  value0: BigInt;
  value1: BigInt;
...
export class WeightedPoolNoAMFactory extends ethereum.SmartContract {
  static bind(address: Address): WeightedPoolNoAMFactory {
    return new WeightedPoolNoAMFactory("WeightedPoolNoAMFactory", address);
  }
  ...
  getCreationCodeContracts(): WeightedPoolNoAMFactory__getCreationCodeContractsResult {
    let result = super.call(
    ...
    return new WeightedPoolNoAMFactory__getCreationCodeContractsResult(
      result[0].toAddress(),
      result[1].toAddress()
    );
  }
  ...
  try_getCreationCodeContracts(): ethereum.CallResult<
    WeightedPoolNoAMFactory__getCreationCodeContractsResult
  > {
    let result = super.tryCall(
      "getCreationCodeContracts",
      "getCreationCodeContracts():(address,address)",
    ...
    return ethereum.CallResult.fromValue(
      new WeightedPoolNoAMFactory__getCreationCodeContractsResult(
        value[0].toAddress(),
        value[1].toAddress()
      )
    );
  ...
  getPauseConfiguration(): WeightedPoolNoAMFactory__getPauseConfigurationResult {
    let result = super.call(
    ...
    return new WeightedPoolNoAMFactory__getPauseConfigurationResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_getPauseConfiguration(): ethereum.CallResult<
    WeightedPoolNoAMFactory__getPauseConfigurationResult
  > {
    let result = super.tryCall(
      "getPauseConfiguration",
      "getPauseConfiguration():(uint256,uint256)",
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new WeightedPoolNoAMFactory__getPauseConfigurationResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
